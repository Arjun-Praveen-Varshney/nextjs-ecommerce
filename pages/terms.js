        ...
        <section className="text-gray-600 body-font">
          <div className="text-black-600 mx-2 md:mx-10 my-2 py-24">
            ...
            <p className="px-10 py-2">
              ...
              of meeting the Clients needs in respect of provision of the
              Companys stated services, in accordance with and subject to,
            ...
            <p className="px-10 py-2">
              ...
              to amen these terms and conditions and its linking policy at any
            ...
            <p className="px-10 py-2">
              ...
              for peach of statutory duty. As long as the website and the
