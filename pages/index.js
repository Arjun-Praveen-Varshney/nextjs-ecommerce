  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="An e-commerce store developed by Arjun Varshney and CodeWithHarry in a team."
        />
      ...
      <div>
        <div>
          <img src="/ARJUN.png" alt="" className="w-screen h-[500px]" />
        </div>
            ...
            <div className="flex flex-wrap -m-4">
              <div className="xl:w-1/4 md:w-1/2 p-4">
                <div className="bg-gray-100 cursor-pointer p-6 rounded-lg">
                  <img
                    className="rounded w-full object-cover object-top mb-6"
                    src="/tshirt.jpg"
                    alt="content"
                  />
            ...
            <div className="flex flex-wrap justify-center -m-4">
              <div className="w-full xl:w-1/3 md:w-1/2 p-4">
                <div className="border border-gray-200 p-6 rounded-lg text-center">
                  <div className="w-10 h-10 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-4 text-center">
                    <svg
                      stroke="currentColor"
                      fill="currentColor"
                      strokeWidth="0"
              ...
              <div className="w-full xl:w-1/3 md:w-1/2 p-4">
                <div className="border border-gray-200 p-6 rounded-lg text-center">
                  ...
                  <p className="leading-relaxed text-base text-center">
                    Amazing offers and discounts available.
                  </p>
                </div>
              </div>
            </div>
