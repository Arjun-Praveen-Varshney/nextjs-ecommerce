            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div className="flex">
                  ...
                  {Object.keys(variants).includes("orange") &&
                    Object.keys(variants["orange"]).includes(size) && (
                      <button
                        onClick={() => refreshVariant(size, "orange")}
              ...
              <div className="flex">
                ...
                <button
                  ...
                  className="flex ml-8 text-white bg-indigo-500 disabled:bg-indigo-300 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-indigo-600 rounded"
                >
                  Buy Now
                </button>
                <button
                  ...
                  className="flex ml-4 text-white bg-indigo-500 disabled:bg-indigo-300 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-indigo-600 rounded"
                >
                  Add to Cart
                </button>
